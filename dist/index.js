...
var toggle = require('@/_components/@ui/toggle');
var utils = require('@/_lib/utils');
var button = require('@/_components/@ui/button');
var label = require('@/_components/@ui/label');
...
function Label$2(_a) {
    ...
    return (jsxRuntime.jsx(Root$b, __assign({ "data-slot": "label", className: cn("flex items-center gap-2 text-sm leading-none font-medium select-none group-data-[disabled=true]:pointer-events-none group-data-[disabled=true]:opacity-50 peer-disabled:cursor-not-allowed peer-disabled:opacity-50", className) }, props)));
}
...
function Badge(_a) {
    ...
    return (jsxRuntime.jsx(Comp, __assign({ "data-slot": "badge", className: cn(badgeVariants({ variant: variant }), className) }, props)));
}
...
var Accordion$1 = React.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(Collection$4.Provider, { scope: props.__scopeAccordion, children: type === "multiple" ? /* @__PURE__ */ jsxRuntime.jsx(AccordionImplMultiple, { ...multipleProps, ref: forwardedRef }) : /* @__PURE__ */ jsxRuntime.jsx(AccordionImplSingle, { ...singleProps, ref: forwardedRef }) });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      AccordionImplProvider,
      {
        ...
        direction: dir,
        orientation,
        children: /* @__PURE__ */ jsxRuntime.jsx(Collection$4.Slot, { scope: __scopeAccordion, children: /* @__PURE__ */ jsxRuntime.jsx(
          Primitive.div,
          {
            ...accordionProps,
...
var AccordionTrigger$1 = React.forwardRef(
  (props, forwardedRef) => {
    ...
    const collapsibleScope = useCollapsibleScope(__scopeAccordion);
    return /* @__PURE__ */ jsxRuntime.jsx(Collection$4.ItemSlot, { scope: __scopeAccordion, children: /* @__PURE__ */ jsxRuntime.jsx(
      Trigger$7,
      {
...
function Accordion(_a) {
    var props = __rest(_a, []);
    return jsxRuntime.jsx(Root2$6, __assign({ "data-slot": "accordion" }, props));
}
function AccordionItem(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(Item$2, __assign({ "data-slot": "accordion-item", className: cn("border-b last:border-b-0", className) }, props)));
}
function AccordionTrigger(_a) {
    var className = _a.className, children = _a.children, props = __rest(_a, ["className", "children"]);
    return (jsxRuntime.jsx(Header, { className: "flex", children: jsxRuntime.jsxs(Trigger2, __assign({ "data-slot": "accordion-trigger", className: cn("focus-visible:border-ring focus-visible:ring-ring/50 flex flex-1 items-start justify-between gap-4 rounded-md py-4 text-left text-sm font-medium transition-all outline-none hover:underline focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-50 [&[data-state=open]>svg]:rotate-180", className) }, props, { children: [children, jsxRuntime.jsx(ChevronDown, { className: "text-muted-foreground pointer-events-none size-4 shrink-0 translate-y-0.5 transition-transform duration-200" })] })) }));
}
function AccordionContent(_a) {
    var className = _a.className, children = _a.children, props = __rest(_a, ["className", "children"]);
    return (jsxRuntime.jsx(Content2$6, __assign({ "data-slot": "accordion-content", className: "data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down overflow-hidden text-sm" }, props, { children: jsxRuntime.jsx("div", { className: cn("pt-0 pb-4", className), children: children }) })));
}
...
function Avatar(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(Root$9, __assign({ "data-slot": "avatar", className: cn("relative flex size-8 shrink-0 overflow-hidden rounded-full", className) }, props)));
}
function AvatarImage(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(Image, __assign({ "data-slot": "avatar-image", className: cn("aspect-square size-full", className) }, props)));
}
function AvatarFallback(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(Fallback, __assign({ "data-slot": "avatar-fallback", className: cn("bg-muted flex size-full items-center justify-center rounded-full", className) }, props)));
}
...
function Checkbox(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(Checkbox$1, __assign({ "data-slot": "checkbox", className: cn("peer border-input dark:bg-input/30 data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground dark:data-[state=checked]:bg-primary data-[state=checked]:border-primary focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive size-4 shrink-0 rounded-[4px] border shadow-xs transition-shadow outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50", className) }, props, { children: jsxRuntime.jsx(CheckboxIndicator, { "data-slot": "checkbox-indicator", className: "flex items-center justify-center text-current transition-none", children: jsxRuntime.jsx(Check, { className: "size-3.5" }) }) })));
}
...
var RovingFocusGroup = React__namespace.forwardRef(
  (props, forwardedRef) => {
    return /* @__PURE__ */ jsxRuntime.jsx(Collection$3.Provider, { scope: props.__scopeRovingFocusGroup, children: /* @__PURE__ */ jsxRuntime.jsx(Collection$3.Slot, { scope: props.__scopeRovingFocusGroup, children: /* @__PURE__ */ jsxRuntime.jsx(RovingFocusGroupImpl, { ...props, ref: forwardedRef }) }) });
  }
);
...
var MenuPortal = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(PortalProvider$3, { scope: __scopeMenu, forceMount, children: /* @__PURE__ */ jsxRuntime.jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntime.jsx(Portal$5, { asChild: true, container, children }) }) });
};
...
var MenuContent = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(Collection$2.Provider, { scope: props.__scopeMenu, children: /* @__PURE__ */ jsxRuntime.jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntime.jsx(Collection$2.Slot, { scope: props.__scopeMenu, children: rootContext.modal ? /* @__PURE__ */ jsxRuntime.jsx(MenuRootContentModal, { ...contentProps, ref: forwardedRef }) : /* @__PURE__ */ jsxRuntime.jsx(MenuRootContentNonModal, { ...contentProps, ref: forwardedRef }) }) }) });
  }
);
...
var MenuSubContent = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    const ref = React__namespace.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref);
    return /* @__PURE__ */ jsxRuntime.jsx(Collection$2.Provider, { scope: props.__scopeMenu, children: /* @__PURE__ */ jsxRuntime.jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntime.jsx(Collection$2.Slot, { scope: props.__scopeMenu, children: /* @__PURE__ */ jsxRuntime.jsx(
      MenuContentImpl,
      {
...
function DropdownMenu(_a) {
    var props = __rest(_a, []);
    return jsxRuntime.jsx(Root2$4, __assign({ "data-slot": "dropdown-menu" }, props));
}
function DropdownMenuPortal(_a) {
    var props = __rest(_a, []);
    return (jsxRuntime.jsx(Portal2$1, __assign({ "data-slot": "dropdown-menu-portal" }, props)));
}
function DropdownMenuTrigger(_a) {
    var props = __rest(_a, []);
    return (jsxRuntime.jsx(Trigger$6, __assign({ "data-slot": "dropdown-menu-trigger" }, props)));
}
function DropdownMenuContent(_a) {
    var className = _a.className, _b = _a.sideOffset, sideOffset = _b === void 0 ? 4 : _b, props = __rest(_a, ["className", "sideOffset"]);
    return (jsxRuntime.jsx(Portal2$1, { children: jsxRuntime.jsx(Content2$4, __assign({ "data-slot": "dropdown-menu-content", sideOffset: sideOffset, className: cn("bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 max-h-(--radix-dropdown-menu-content-available-height) min-w-[8rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-md border p-1 shadow-md", className) }, props)) }));
}
function DropdownMenuGroup(_a) {
    var props = __rest(_a, []);
    return (jsxRuntime.jsx(Group2, __assign({ "data-slot": "dropdown-menu-group" }, props)));
}
function DropdownMenuItem(_a) {
    ...
    return (jsxRuntime.jsx(Item2$1, __assign({ "data-slot": "dropdown-menu-item", "data-inset": inset, "data-variant": variant, className: cn("focus:bg-accent focus:text-accent-foreground data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive/10 dark:data-[variant=destructive]:focus:bg-destructive/20 data-[variant=destructive]:focus:text-destructive data-[variant=destructive]:*:[svg]:!text-destructive [&_svg:not([class*='text-'])]:text-muted-foreground relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4", className) }, props)));
}
function DropdownMenuCheckboxItem(_a) {
    var className = _a.className, children = _a.children, checked = _a.checked, props = __rest(_a, ["className", "children", "checked"]);
    return (jsxRuntime.jsxs(CheckboxItem2$1, __assign({ "data-slot": "dropdown-menu-checkbox-item", className: cn("focus:bg-accent focus:text-accent-foreground relative flex cursor-default items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4", className), checked: checked }, props, { children: [jsxRuntime.jsx("span", { className: "pointer-events-none absolute left-2 flex size-3.5 items-center justify-center", children: jsxRuntime.jsx(ItemIndicator2$1, { children: jsxRuntime.jsx(Check, { className: "size-4" }) }) }), children] })));
}
function DropdownMenuRadioGroup(_a) {
    var props = __rest(_a, []);
    return (jsxRuntime.jsx(RadioGroup2$1, __assign({ "data-slot": "dropdown-menu-radio-group" }, props)));
}
function DropdownMenuRadioItem(_a) {
    var className = _a.className, children = _a.children, props = __rest(_a, ["className", "children"]);
    return (jsxRuntime.jsxs(RadioItem2$1, __assign({ "data-slot": "dropdown-menu-radio-item", className: cn("focus:bg-accent focus:text-accent-foreground relative flex cursor-default items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4", className) }, props, { children: [jsxRuntime.jsx("span", { className: "pointer-events-none absolute left-2 flex size-3.5 items-center justify-center", children: jsxRuntime.jsx(ItemIndicator2$1, { children: jsxRuntime.jsx(Circle, { className: "size-2 fill-current" }) }) }), children] })));
}
function DropdownMenuLabel(_a) {
    var className = _a.className, inset = _a.inset, props = __rest(_a, ["className", "inset"]);
    return (jsxRuntime.jsx(Label2$1, __assign({ "data-slot": "dropdown-menu-label", "data-inset": inset, className: cn("px-2 py-1.5 text-sm font-medium data-[inset]:pl-8", className) }, props)));
}
function DropdownMenuSeparator(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(Separator2$1, __assign({ "data-slot": "dropdown-menu-separator", className: cn("bg-border -mx-1 my-1 h-px", className) }, props)));
}
function DropdownMenuShortcut(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx("span", __assign({ "data-slot": "dropdown-menu-shortcut", className: cn("text-muted-foreground ml-auto text-xs tracking-widest", className) }, props)));
}
function DropdownMenuSub(_a) {
    var props = __rest(_a, []);
    return jsxRuntime.jsx(Sub2$1, __assign({ "data-slot": "dropdown-menu-sub" }, props));
}
function DropdownMenuSubTrigger(_a) {
    var className = _a.className, inset = _a.inset, children = _a.children, props = __rest(_a, ["className", "inset", "children"]);
    return (jsxRuntime.jsxs(SubTrigger2$1, __assign({ "data-slot": "dropdown-menu-sub-trigger", "data-inset": inset, className: cn("focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground flex cursor-default items-center rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[inset]:pl-8", className) }, props, { children: [children, jsxRuntime.jsx(ChevronRight, { className: "ml-auto size-4" })] })));
}
function DropdownMenuSubContent(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(SubContent2$1, __assign({ "data-slot": "dropdown-menu-sub-content", className: cn("bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 min-w-[8rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden rounded-md border p-1 shadow-lg", className) }, props)));
}
...
var Select$2 = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Root2$5, { ...popperScope, children: /* @__PURE__ */ jsxRuntime.jsxs(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
...
function Select$1(_a) {
    var props = __rest(_a, []);
    return jsxRuntime.jsx(Root2$3, __assign({ "data-slot": "select" }, props));
}
function SelectGroup(_a) {
    var props = __rest(_a, []);
    return jsxRuntime.jsx(Group, __assign({ "data-slot": "select-group" }, props));
}
function SelectValue(_a) {
    var props = __rest(_a, []);
    return jsxRuntime.jsx(Value, __assign({ "data-slot": "select-value" }, props));
}
function SelectTrigger(_a) {
    ...
    return (jsxRuntime.jsxs(Trigger$5, __assign({ "data-slot": "select-trigger", "data-size": size, className: cn("border-input data-[placeholder]:text-muted-foreground [&_svg:not([class*='text-'])]:text-muted-foreground focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:bg-input/30 dark:hover:bg-input/50 flex w-fit items-center justify-between gap-2 rounded-md border bg-transparent px-3 py-2 text-sm whitespace-nowrap shadow-xs transition-[color,box-shadow] outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50 data-[size=default]:h-9 data-[size=sm]:h-8 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4", className) }, props, { children: [children, jsxRuntime.jsx(Icon, { asChild: true, children: jsxRuntime.jsx(ChevronDown, { className: "size-4 opacity-50" }) })] })));
}
function SelectContent(_a) {
    ...
    return (jsxRuntime.jsx(Portal$3, { children: jsxRuntime.jsxs(Content2$3, __assign({ "data-slot": "select-content", className: cn("bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 relative z-50 max-h-(--radix-select-content-available-height) min-w-[8rem] origin-(--radix-select-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-md border shadow-md", position === "popper" &&
...
function SelectLabel(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(Label, __assign({ "data-slot": "select-label", className: cn("text-muted-foreground px-2 py-1.5 text-xs", className) }, props)));
}
function SelectItem(_a) {
    var className = _a.className, children = _a.children, props = __rest(_a, ["className", "children"]);
    return (jsxRuntime.jsxs(Item, __assign({ "data-slot": "select-item", className: cn("focus:bg-accent focus:text-accent-foreground [&_svg:not([class*='text-'])]:text-muted-foreground relative flex w-full cursor-default items-center gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2", className) }, props, { children: [jsxRuntime.jsx("span", { className: "absolute right-2 flex size-3.5 items-center justify-center", children: jsxRuntime.jsx(ItemIndicator, { children: jsxRuntime.jsx(Check, { className: "size-4" }) }) }), jsxRuntime.jsx(ItemText, { children: children })] })));
}
function SelectSeparator(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(Separator$2, __assign({ "data-slot": "select-separator", className: cn("bg-border pointer-events-none -mx-1 my-1 h-px", className) }, props)));
}
function SelectScrollUpButton(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(ScrollUpButton, __assign({ "data-slot": "select-scroll-up-button", className: cn("flex cursor-default items-center justify-center py-1", className) }, props, { children: jsxRuntime.jsx(ChevronUp, { className: "size-4" }) })));
}
function SelectScrollDownButton(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(ScrollDownButton, __assign({ "data-slot": "select-scroll-down-button", className: cn("flex cursor-default items-center justify-center py-1", className) }, props, { children: jsxRuntime.jsx(ChevronDown, { className: "size-4" }) })));
}
...
function Switch(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(Root$5, __assign({ "data-slot": "switch", className: cn("peer data-[state=checked]:bg-primary data-[state=unchecked]:bg-input focus-visible:border-ring focus-visible:ring-ring/50 dark:data-[state=unchecked]:bg-input/80 inline-flex h-[1.15rem] w-8 shrink-0 items-center rounded-full border border-transparent shadow-xs transition-all outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50", className) }, props, { children: jsxRuntime.jsx(Thumb, { "data-slot": "switch-thumb", className: cn("bg-background dark:data-[state=unchecked]:bg-foreground dark:data-[state=checked]:bg-primary-foreground pointer-events-none block size-4 rounded-full ring-0 transition-transform data-[state=checked]:translate-x-[calc(100%-2px)] data-[state=unchecked]:translate-x-0") }) })));
}
...
function Tabs(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(Root2$2, __assign({ "data-slot": "tabs", className: cn("flex flex-col gap-2", className) }, props)));
}
function TabsList(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(List, __assign({ "data-slot": "tabs-list", className: cn("bg-muted text-muted-foreground inline-flex h-9 w-fit items-center justify-center rounded-lg p-[3px]", className) }, props)));
}
...
function TabsContent(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(Content$1, __assign({ "data-slot": "tabs-content", className: cn("flex-1 outline-none", className) }, props)));
}
...
function Toggle(_a) {
    ...
    return (jsxRuntime.jsx(Root$4, __assign({ "data-slot": "toggle", className: cn(toggleVariants({ variant: variant, size: size, className: className })) }, props)));
}
...
function ToggleGroup(_a) {
    ...
    return (jsxRuntime.jsx(Root2$1, __assign({ "data-slot": "toggle-group", "data-variant": variant, "data-size": size, className: cn("group/toggle-group flex w-fit items-center rounded-md data-[variant=outline]:shadow-xs", className) }, props, { children: jsxRuntime.jsx(ToggleGroupContext.Provider, { value: { variant: variant, size: size }, children: children }) })));
}
function ToggleGroupItem(_a) {
    ...
    return (jsxRuntime.jsx(Item2, __assign({ "data-slot": "toggle-group-item", "data-variant": context.variant || variant, "data-size": context.size || size, className: cn(toggle.toggleVariants({
...
var TooltipPortal = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(PortalProvider$2, { scope: __scopeTooltip, forceMount, children: /* @__PURE__ */ jsxRuntime.jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntime.jsx(Portal$5, { asChild: true, container, children }) }) });
};
...
function TooltipProvider(_a) {
    ...
    return (jsxRuntime.jsx(Provider, __assign({ "data-slot": "tooltip-provider", delayDuration: delayDuration }, props)));
}
function Tooltip(_a) {
    var props = __rest(_a, []);
    return (jsxRuntime.jsx(TooltipProvider, { children: jsxRuntime.jsx(Root3$1, __assign({ "data-slot": "tooltip" }, props)) }));
}
function TooltipTrigger(_a) {
    var props = __rest(_a, []);
    return jsxRuntime.jsx(Trigger$3, __assign({ "data-slot": "tooltip-trigger" }, props));
}
function TooltipContent(_a) {
    ...
    return (jsxRuntime.jsx(Portal$2, { children: jsxRuntime.jsxs(Content2$2, __assign({ "data-slot": "tooltip-content", sideOffset: sideOffset, className: cn("bg-primary text-primary-foreground animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 w-fit origin-(--radix-tooltip-content-transform-origin) rounded-md px-3 py-1.5 text-xs text-balance", className) }, props, { children: [children, jsxRuntime.jsx(Arrow2, { className: "bg-primary fill-primary z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]" })] })) }));
}
...
function Progress(_a) {
    ...
    return (jsxRuntime.jsx(Root$3, __assign({ "data-slot": "progress", className: cn("bg-primary/20 relative h-2 w-full overflow-hidden rounded-full", className) }, props, { children: jsxRuntime.jsx(Indicator, { "data-slot": "progress-indicator", className: "bg-primary h-full w-full flex-1 transition-all", style: { transform: "translateX(-".concat(100 - (value || 0), "%)") } }) })));
}
...
function Separator(_a) {
    ...
    return (jsxRuntime.jsx(Root$2, __assign({ "data-slot": "separator", decorative: decorative, orientation: orientation, className: utils.cn("bg-border shrink-0 data-[orientation=horizontal]:h-px data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-px", className) }, props)));
}
...
function Alert(_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ "data-slot": "alert", role: "alert", className: cn(alertVariants({ variant: variant }), className) }, props)));
}
function AlertTitle(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx("div", __assign({ "data-slot": "alert-title", className: cn("col-start-2 line-clamp-1 min-h-4 font-medium tracking-tight", className) }, props)));
}
function AlertDescription(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx("div", __assign({ "data-slot": "alert-description", className: cn("text-muted-foreground col-start-2 grid justify-items-start gap-1 text-sm [&_p]:leading-relaxed", className) }, props)));
}
...
function Calendar(_a) {
    ...
    return (jsxRuntime.jsx(DayPicker, __assign({ showOutsideDays: showOutsideDays, className: cn("bg-background group/calendar p-3 [--cell-size:--spacing(8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent", String.raw(templateObject_1 || (templateObject_1 = __makeTemplateObject(["rtl:**:[.rdp-button_next>svg]:rotate-180"], ["rtl:**:[.rdp-button\\_next>svg]:rotate-180"]))), String.raw(templateObject_2 || (templateObject_2 = __makeTemplateObject(["rtl:**:[.rdp-button_previous>svg]:rotate-180"], ["rtl:**:[.rdp-button\\_previous>svg]:rotate-180"]))), className), captionLayout: captionLayout, formatters: __assign({ formatMonthDropdown: function (date) {
                return date.toLocaleString("default", { month: "short" });
            } }, formatters), classNames: __assign({ root: cn("w-fit", defaultClassNames.root), months: cn("flex gap-4 flex-col md:flex-row relative", defaultClassNames.months), month: cn("flex flex-col w-full gap-4", defaultClassNames.month), nav: cn("flex items-center gap-1 w-full absolute top-0 inset-x-0 justify-between", defaultClassNames.nav), button_previous: cn(button.buttonVariants({ variant: buttonVariant }), "size-(--cell-size) aria-disabled:opacity-50 p-0 select-none", defaultClassNames.button_previous), button_next: cn(button.buttonVariants({ variant: buttonVariant }), "size-(--cell-size) aria-disabled:opacity-50 p-0 select-none", defaultClassNames.button_next), month_caption: cn("flex items-center justify-center h-(--cell-size) w-full px-(--cell-size)", defaultClassNames.month_caption), dropdowns: cn("w-full flex items-center text-sm font-medium justify-center h-(--cell-size) gap-1.5", defaultClassNames.dropdowns), dropdown_root: cn("relative has-focus:border-ring border border-input shadow-xs has-focus:ring-ring/50 has-focus:ring-[3px] rounded-md", defaultClassNames.dropdown_root), dropdown: cn("absolute inset-0 opacity-0", defaultClassNames.dropdown), caption_label: cn("select-none font-medium", captionLayout === "label"
                ? "text-sm"
                ...
                return (jsxRuntime.jsx("div", __assign({ "data-slot": "calendar", ref: rootRef, className: cn(className) }, props)));
            }, Chevron: function (_a) {
                var className = _a.className, orientation = _a.orientation, props = __rest(_a, ["className", "orientation"]);
                if (orientation === "left") {
                    return (jsxRuntime.jsx(ChevronLeft, __assign({ className: cn("size-4", className) }, props)));
                }
                if (orientation === "right") {
                    return (jsxRuntime.jsx(ChevronRight, __assign({ className: cn("size-4", className) }, props)));
                }
                return (jsxRuntime.jsx(ChevronDown, __assign({ className: cn("size-4", className) }, props)));
            }, DayButton: CalendarDayButton, WeekNumber: function (_a) {
                var children = _a.children, props = __rest(_a, ["children"]);
                return (jsxRuntime.jsx("td", __assign({}, props, { children: jsxRuntime.jsx("div", { className: "flex size-(--cell-size) items-center justify-center text-center", children: children }) })));
            } }, components) }, props)));
}
function CalendarDayButton(_a) {
    ...
    return (jsxRuntime.jsx(button.Button, __assign({ ref: ref, variant: "ghost", size: "icon", "data-day": day.date.toLocaleDateString(), "data-selected-single": modifiers.selected &&
...
function Table(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx("div", { "data-slot": "table-container", className: "relative w-full overflow-x-auto", children: jsxRuntime.jsx("table", __assign({ "data-slot": "table", className: cn("w-full caption-bottom text-sm", className) }, props)) }));
}
function TableHeader(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx("thead", __assign({ "data-slot": "table-header", className: cn("[&_tr]:border-b", className) }, props)));
}
function TableBody(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx("tbody", __assign({ "data-slot": "table-body", className: cn("[&_tr:last-child]:border-0", className) }, props)));
}
function TableFooter(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx("tfoot", __assign({ "data-slot": "table-footer", className: cn("bg-muted/50 border-t font-medium [&>tr]:last:border-b-0", className) }, props)));
}
function TableRow(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx("tr", __assign({ "data-slot": "table-row", className: cn("hover:bg-muted/50 data-[state=selected]:bg-muted border-b transition-colors", className) }, props)));
}
function TableHead(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx("th", __assign({ "data-slot": "table-head", className: cn("text-foreground h-10 px-2 text-left align-middle font-medium whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]", className) }, props)));
}
function TableCell(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx("td", __assign({ "data-slot": "table-cell", className: cn("p-2 align-middle whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]", className) }, props)));
}
function TableCaption(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx("caption", __assign({ "data-slot": "table-caption", className: cn("text-muted-foreground mt-4 text-sm", className) }, props)));
}
...
var DialogPortal = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(PortalProvider$1, { scope: __scopeDialog, forceMount, children: React__namespace.Children.map(children, (child) => /* @__PURE__ */ jsxRuntime.jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntime.jsx(Portal$5, { asChild: true, container, children: child }) })) });
};
...
function Sheet(_a) {
    var props = __rest(_a, []);
    return jsxRuntime.jsx(Root, __assign({ "data-slot": "sheet" }, props));
}
function SheetTrigger(_a) {
    var props = __rest(_a, []);
    return jsxRuntime.jsx(Trigger$2, __assign({ "data-slot": "sheet-trigger" }, props));
}
function SheetClose(_a) {
    var props = __rest(_a, []);
    return jsxRuntime.jsx(Close, __assign({ "data-slot": "sheet-close" }, props));
}
function SheetPortal(_a) {
    var props = __rest(_a, []);
    return jsxRuntime.jsx(Portal$1, __assign({ "data-slot": "sheet-portal" }, props));
}
function SheetOverlay(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(Overlay, __assign({ "data-slot": "sheet-overlay", className: cn("data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/50", className) }, props)));
}
function SheetContent(_a) {
    ...
    return (jsxRuntime.jsxs(SheetPortal, { children: [jsxRuntime.jsx(SheetOverlay, {}), jsxRuntime.jsxs(Content, __assign({ "data-slot": "sheet-content", className: cn("bg-background data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500", side === "right" &&
                    ...
                    "data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom inset-x-0 bottom-0 h-auto border-t", className) }, props, { children: [children, jsxRuntime.jsxs(Close, { className: "ring-offset-background focus:ring-ring data-[state=open]:bg-secondary absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none", children: [jsxRuntime.jsx(X, { className: "size-4" }), jsxRuntime.jsx("span", { className: "sr-only", children: "Close" })] })] }))] }));
}
function SheetHeader(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx("div", __assign({ "data-slot": "sheet-header", className: cn("flex flex-col gap-1.5 p-4", className) }, props)));
}
function SheetFooter(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx("div", __assign({ "data-slot": "sheet-footer", className: cn("mt-auto flex flex-col gap-2 p-4", className) }, props)));
}
function SheetTitle(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(Title, __assign({ "data-slot": "sheet-title", className: cn("text-foreground font-semibold", className) }, props)));
}
function SheetDescription(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(Description, __assign({ "data-slot": "sheet-description", className: cn("text-muted-foreground text-sm", className) }, props)));
}
...
var PopoverPortal = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(PortalProvider, { scope: __scopePopover, forceMount, children: /* @__PURE__ */ jsxRuntime.jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntime.jsx(Portal$5, { asChild: true, container, children }) }) });
};
...
function Popover(_a) {
    var props = __rest(_a, []);
    return jsxRuntime.jsx(Root2, __assign({ "data-slot": "popover" }, props));
}
function PopoverTrigger(_a) {
    var props = __rest(_a, []);
    return jsxRuntime.jsx(Trigger$1, __assign({ "data-slot": "popover-trigger" }, props));
}
function PopoverContent(_a) {
    ...
    return (jsxRuntime.jsx(Portal, { children: jsxRuntime.jsx(Content2$1, __assign({ "data-slot": "popover-content", align: align, sideOffset: sideOffset, className: cn("bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 w-72 origin-(--radix-popover-content-transform-origin) rounded-md border p-4 shadow-md outline-hidden", className) }, props)) }));
}
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(Collection.ItemSlot, { scope: __scopeMenubar, value: menuContext.value, disabled, children: /* @__PURE__ */ jsxRuntime.jsx(
      Item$1,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(Anchor2, { asChild: true, ...menuScope, children: /* @__PURE__ */ jsxRuntime.jsx(
          Primitive.button,
          {
            type: "button",
            role: "menuitem",
...
var MenubarGroup = React__namespace.forwardRef(
  (props, forwardedRef) => {
...
function Menubar(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(Root3, __assign({ "data-slot": "menubar", className: cn("bg-background flex h-9 items-center gap-1 rounded-md border p-1 shadow-xs", className) }, props)));
}
function MenubarMenu(_a) {
    var props = __rest(_a, []);
    return jsxRuntime.jsx(Menu, __assign({ "data-slot": "menubar-menu" }, props));
}
function MenubarPortal(_a) {
    var props = __rest(_a, []);
    return jsxRuntime.jsx(Portal2, __assign({ "data-slot": "menubar-portal" }, props));
}
function MenubarRadioGroup(_a) {
    var props = __rest(_a, []);
    return (jsxRuntime.jsx(RadioGroup2, __assign({ "data-slot": "menubar-radio-group" }, props)));
}
function MenubarTrigger(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(Trigger, __assign({ "data-slot": "menubar-trigger", className: cn("focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground flex items-center rounded-sm px-2 py-1 text-sm font-medium outline-hidden select-none", className) }, props)));
}
function MenubarContent(_a) {
    ...
    return (jsxRuntime.jsx(MenubarPortal, { children: jsxRuntime.jsx(Content2, __assign({ "data-slot": "menubar-content", align: align, alignOffset: alignOffset, sideOffset: sideOffset, className: cn("bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 min-w-[12rem] origin-(--radix-menubar-content-transform-origin) overflow-hidden rounded-md border p-1 shadow-md", className) }, props)) }));
}
function MenubarItem(_a) {
    var className = _a.className, inset = _a.inset, _b = _a.variant, variant = _b === void 0 ? "default" : _b, props = __rest(_a, ["className", "inset", "variant"]);
    return (jsxRuntime.jsx(Item3, __assign({ "data-slot": "menubar-item", "data-inset": inset, "data-variant": variant, className: cn("focus:bg-accent focus:text-accent-foreground data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive/10 dark:data-[variant=destructive]:focus:bg-destructive/20 data-[variant=destructive]:focus:text-destructive data-[variant=destructive]:*:[svg]:!text-destructive [&_svg:not([class*='text-'])]:text-muted-foreground relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4", className) }, props)));
}
function MenubarCheckboxItem(_a) {
    var className = _a.className, children = _a.children, checked = _a.checked, props = __rest(_a, ["className", "children", "checked"]);
    return (jsxRuntime.jsxs(CheckboxItem2, __assign({ "data-slot": "menubar-checkbox-item", className: cn("focus:bg-accent focus:text-accent-foreground relative flex cursor-default items-center gap-2 rounded-xs py-1.5 pr-2 pl-8 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4", className), checked: checked }, props, { children: [jsxRuntime.jsx("span", { className: "pointer-events-none absolute left-2 flex size-3.5 items-center justify-center", children: jsxRuntime.jsx(ItemIndicator2, { children: jsxRuntime.jsx(Check, { className: "size-4" }) }) }), children] })));
}
function MenubarRadioItem(_a) {
    var className = _a.className, children = _a.children, props = __rest(_a, ["className", "children"]);
    return (jsxRuntime.jsxs(RadioItem2, __assign({ "data-slot": "menubar-radio-item", className: cn("focus:bg-accent focus:text-accent-foreground relative flex cursor-default items-center gap-2 rounded-xs py-1.5 pr-2 pl-8 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4", className) }, props, { children: [jsxRuntime.jsx("span", { className: "pointer-events-none absolute left-2 flex size-3.5 items-center justify-center", children: jsxRuntime.jsx(ItemIndicator2, { children: jsxRuntime.jsx(Circle, { className: "size-2 fill-current" }) }) }), children] })));
}
function MenubarLabel(_a) {
    var className = _a.className, inset = _a.inset, props = __rest(_a, ["className", "inset"]);
    return (jsxRuntime.jsx(Label2, __assign({ "data-slot": "menubar-label", "data-inset": inset, className: cn("px-2 py-1.5 text-sm font-medium data-[inset]:pl-8", className) }, props)));
}
function MenubarSeparator(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(Separator2, __assign({ "data-slot": "menubar-separator", className: cn("bg-border -mx-1 my-1 h-px", className) }, props)));
}
function MenubarShortcut(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx("span", __assign({ "data-slot": "menubar-shortcut", className: cn("text-muted-foreground ml-auto text-xs tracking-widest", className) }, props)));
}
function MenubarSub(_a) {
    var props = __rest(_a, []);
    return jsxRuntime.jsx(Sub2, __assign({ "data-slot": "menubar-sub" }, props));
}
function MenubarSubTrigger(_a) {
    var className = _a.className, inset = _a.inset, children = _a.children, props = __rest(_a, ["className", "inset", "children"]);
    return (jsxRuntime.jsxs(SubTrigger2, __assign({ "data-slot": "menubar-sub-trigger", "data-inset": inset, className: cn("focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground flex cursor-default items-center rounded-sm px-2 py-1.5 text-sm outline-none select-none data-[inset]:pl-8", className) }, props, { children: [children, jsxRuntime.jsx(ChevronRight, { className: "ml-auto h-4 w-4" })] })));
}
function MenubarSubContent(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(SubContent2, __assign({ "data-slot": "menubar-sub-content", className: cn("bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 min-w-[8rem] origin-(--radix-menubar-content-transform-origin) overflow-hidden rounded-md border p-1 shadow-lg", className) }, props)));
}
...
const useIsomorphicLayoutEffect$1 = React.useLayoutEffect ;
...
function ResizablePanelGroup(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (jsxRuntime.jsx(PanelGroup, __assign({ "data-slot": "resizable-panel-group", className: cn("flex h-full w-full data-[panel-group-direction=vertical]:flex-col", className) }, props)));
}
function ResizablePanel(_a) {
    var props = __rest(_a, []);
    return jsxRuntime.jsx(Panel, __assign({ "data-slot": "resizable-panel" }, props));
}
function ResizableHandle(_a) {
    var withHandle = _a.withHandle, className = _a.className, props = __rest(_a, ["withHandle", "className"]);
    return (jsxRuntime.jsx(PanelResizeHandle, __assign({ "data-slot": "resizable-handle", className: cn("bg-border focus-visible:ring-ring relative flex w-px items-center justify-center after:absolute after:inset-y-0 after:left-1/2 after:w-1 after:-translate-x-1/2 focus-visible:ring-1 focus-visible:ring-offset-1 focus-visible:outline-hidden data-[panel-group-direction=vertical]:h-px data-[panel-group-direction=vertical]:w-full data-[panel-group-direction=vertical]:after:left-0 data-[panel-group-direction=vertical]:after:h-1 data-[panel-group-direction=vertical]:after:w-full data-[panel-group-direction=vertical]:after:-translate-y-1/2 data-[panel-group-direction=vertical]:after:translate-x-0 [&[data-panel-group-direction=vertical]>div]:rotate-90", className) }, props, { children: withHandle && (jsxRuntime.jsx("div", { className: "bg-border z-10 flex h-4 w-3 items-center justify-center rounded-xs border", children: jsxRuntime.jsx(GripVertical, { className: "size-2.5" }) })) })));
}
...
var FormField = function (_a) {
    var props = __rest(_a, []);
    return (jsxRuntime.jsx(FormFieldContext.Provider, { value: { name: props.name }, children: jsxRuntime.jsx(Controller, __assign({}, props)) }));
};
...
function FormItem(_a) {
    ...
    return (jsxRuntime.jsx(FormItemContext.Provider, { value: { id: id }, children: jsxRuntime.jsx("div", __assign({ "data-slot": "form-item", className: cn("grid gap-2", className) }, props)) }));
}
function FormLabel(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var _b = useFormField(), error = _b.error, formItemId = _b.formItemId;
    return (jsxRuntime.jsx(label.Label, __assign({ "data-slot": "form-label", "data-error": !!error, className: cn("data-[error=true]:text-destructive", className), htmlFor: formItemId }, props)));
}
function FormControl(_a) {
    ...
    return (jsxRuntime.jsx(Slot$4, __assign({ "data-slot": "form-control", id: formItemId, "aria-describedby": !error
...
function FormDescription(_a) {
    ...
    return (jsxRuntime.jsx("p", __assign({ "data-slot": "form-description", id: formDescriptionId, className: cn("text-muted-foreground text-sm", className) }, props)));
}
